      ...
      <div className="max-w-3xl mx-auto px-6 py-20 md:py-28">
        ...
        <section className="mb-24">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { step: "01", label: "Domain immersion", desc: "Terminology and component functions." },
              { step: "02", label: "Data vis exploration", desc: "Methods to communicate system health." },
              { step: "03", label: "Ideate and wireframe", desc: "Component data into dashboard layouts." },
              { step: "04", label: "Structural design", desc: "Final representations for review." },
            ].map((item) => (
              <div key={item.step}>
