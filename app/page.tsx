  ...
  return (
    <div>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between mb-12">
            <div className="bg-white rounded-xl px-6 py-4 shadow-sm border border-border/40">
              <h2 className="text-xl md:text-2xl font-semibold text-[#09332C]">Selected work</h2>
            </div>
            <Link
              href="/projects"
      ...
      <section className="py-20 md:py-28 bg-card">
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-white rounded-xl px-6 py-4 shadow-sm border border-border/40 inline-block mb-12">
            <h2 className="text-xl md:text-2xl font-semibold text-[#09332C]">How I work</h2>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={step.step} className="p-6 bg-background rounded-lg border border-border/50 hover:border-[#F0531C]/20 transition-all duration-200 group">
                ...
                <h3 className="text-base font-semibold text-foreground mt-2 group-hover:text-[#F0531C] transition-colors duration-200">
                  {step.title}
                </h3>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6">
          <div className="bg-[#F7EDDA] rounded-lg p-10 md:p-14">
            ...
            <h2 className="text-2xl md:text-3xl font-semibold text-[#09332C] text-balance leading-snug max-w-xl">
